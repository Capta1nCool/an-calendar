      ...
      if (errors.length > 0) {
        ...
        for (const file of outputFiles) {
          ...
          if (outputPath.match(/\.js$/)) {
            const base64JavascriptContent = Buffer.from(file.text).toString(
              "base64",
            );
            htmlContent = htmlContent.replace(
              "__BASE64JAVASCRIPTCONTENT__",
              base64JavascriptContent,
            );
        ...
        outputFiles.forEach((file) => {
          ...
          if (outputPath.match(/\.css$/)) {
            ...
            const htmlContent = fs.readFileSync(
              path.join("assets", "embed.dev.html"),
              "utf8",
            );
